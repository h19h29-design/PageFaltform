...
export default async function NewFamilyPage(props: NewFamilyPageProps) {
  ...
  return (
    <PageShell
      ...
      title="새 미니 가족 홈 만들기"
      subtitle="내부망에서 바로 열어 볼 수 있는 가족 홈을 하나 더 만들고, 모듈 조합까지 한 번에 정합니다."
      actions={
    ...
    >
      <HeroCard
        ...
        title="직접 만든 여러 개의 미니 가족 홈을 쌓아갈 수 있습니다"
        subtitle="가족 이름, 주소 슬러그, 입장 비밀번호, 테마와 모듈 구성을 정하면 서버 파일에 저장되어 내부망의 다른 기기에서도 같은 홈을 볼 수 있습니다."
        meta={
          <>
